...
menu = ["Title Page", "DDPM - Class Conditioned", "DDPM - Classifier Guidance", "2D and 3D Diffusion Demonstration", "Option 3"]
choice = st.selectbox("Menu", menu)

if choice == "DDPM - Class Conditioned":
    st.switch_page("pages/class_conditioned_ddpm_demo.py")

elif choice == "DDPM - Classifier Guidance":
    st.switch_page("pages/classifier_guidance_demo.py")
