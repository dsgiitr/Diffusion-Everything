...
class DDPM():
    ...
    def generate(self, guidanceScale, labels, streamlit_callback = None): #Reverse process
        ...
        for t in tqdm(torch.arange(self.timesteps - 1, 0, -1, device = device)):
            ...
            x_T = mean  +  z * ns.sigma[t] - grads * guidanceScale
...
if __name__ == "__main__" :
    ...
    parser.add_argument("--unet-checkpoint", default = "unet.ckpt", type = str , help = "Checkpoint path for UNet")
    parser.add_argument("--clf-checkpoint", default = "clf.ckpt", type = str, help="Checkpoint path for Classifier")
